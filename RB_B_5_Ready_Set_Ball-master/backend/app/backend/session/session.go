...
import (
	...
	"git.linux.iastate.edu/309Fall2017/RB_B_5_Ready_Set_Ball/backend/app/backend/operations/transaction"
...
// AuthSetup setups up a session to have the needed user data from an authentication transaction
...
func (s internalSession) IsValid() bool {
	//TODO: check that it contains only alphabets, -, == and correct length
	//TODO: there might be no need for this
	return true
}
